...
#define STRING_CONFIG_H_AUTHOR "(Marco, Spiderbot)" // Who made the changes.
...
#define DELTA_DIAGONAL_ROD 246.0 + 12.73 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 203.0 // mm
...
// For bots this means top and center of the Cartesian print volume.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {88.89, 88.89, 88.89, 760*1.1/1.42/0.8}  // default steps per unit for Kossel (GT2, 20 tooth)
